...
<CardGroup cols={2}>
  <Card title="Sovereign data protection" icon="shield">
    Your data remains in Europe, protected against exposure to third-party clouds and unauthorized use for AI training.
  </Card>
  <Card title="Guaranteed GDPR compliance" icon="lock">
    European hosting, end-to-end encryption, integrated audit logging for complete traceability and total compliance.
  </Card>
</CardGroup>
...
<Warning>
  Unlike public solutions, your data never leaves Europe: storage, processing, and backups are hosted in GDPR-compliant datacenters, ensuring complete digital sovereignty.
</Warning>

### Intelligent document analysis (optional)
...
[Placeholder for secure architecture diagram]
...
<Expandable title="Example of secure use">
  **User:** Summarize this confidential contract and identify the confidentiality clauses.

  **AI:** The contract includes a confidentiality clause valid until 2026. Summary: "Service agreement with tacit annual renewal."
  (All data is stored and processed in GDPR-compliant European servers, guaranteeing absolute protection against leaks.)
</Expandable>

[Placeholder for interactive example of secure document search]
...
<Info>
  All processing is carried out in a legal European framework, guaranteeing sovereignty, compliance, and maximum confidentiality for your sensitive data.
</Info>

[Placeholder for secure technical diagram]
...
<Check>
  Confidentiality and regulatory compliance become your competitive advantages, distinguishing you from solutions that expose your data.
</Check>

[Placeholder for infographics or client testimonials on security]
...
<Step title="Technical configuration">
  Deployment on sovereign European cloud servers, integrated into your systems with protection guarantees.
</Step>
...
<Note>
  Our solution is **hosted exclusively in Europe**, GDPR compliant, and designed to offer the strictest confidentiality, giving you total control over your data.
</Note>
